...
from model import SSDModel, ModelHelper, nms
import numpy as np
...
#
#
# def calculate_accuracy(test_gen, test_size, BATCH_SIZE, accuracy, x, y, keep_prob, sess):
# 	# Gather class predictions and confidence values
# 	y_pred_conf = preds_conf_val[BATCH_SIZE -1]
