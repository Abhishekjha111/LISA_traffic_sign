...
def find_gt_boxes(raw_data, image_file):
	...
	Returns y_true array that flags the matching default boxes with class ID (-1 means there is nothing)
	"""
...
def data_prep(raw_data):
	...
	data_prep_dict has the folowwing mapping image_file -> [{'class': class_int, 'box_coords': (x1, y1, x2, y2)}, {...}, ...]

	Returns dictionary as: {image_file1: {'y_true_conf': y_true_conf, 'y_true_loc': y_true_loc}, image_file2: ...}
	"""
